...
source(qq("@{BASE_DIR}/scripts/configure/roadmap_configure_primary.R"))
...
if(!all(file.exists(c(qq("@{OUTPUT_DIR}/rds/mean_meth_1kb_cgi.rds"), 
					  qq("@{OUTPUT_DIR}/rds/mean_meth_1kb_cgi_shore.rds"), 
					  qq("@{OUTPUT_DIR}/rds/mean_meth_1kb_neither_cgi_nor_shore.rds")))) && !rerun) {
...
pdf(qq("@{OUTPUT_DIR}/plots/methylation_classification_wgbs_cgi.pdf"), width = 8, height = 10)
...
pdf(qq("@{OUTPUT_DIR}/plots/methylation_classification_wgbs_shore.pdf"), width = 8, height = 10)
...
pdf(qq("@{OUTPUT_DIR}/plots/methylation_classification_wgbs_complement.pdf"), width = 8, height = 10)
...
saveRDS(COLOR, file = qq("@{OUTPUT_DIR}/rds/group_classification_color.rds"))

pdf(qq("@{OUTPUT_DIR}/plots/group_classification.pdf"), width = 4)
...
# cmd = qq("Rscript-3.1.2 /icgc/dkfzlsdf/analysis/B080/guz/roadmap_analysis/re_analysis/scripts/01.sample_groups.R")
