...
\arguments{
  ...
  \item{cutoff}{if subgroup information is provided, cutoff of p-value of the oneway ANOVA test}
  \item{adj_method}{method to calculate adjusted p-values}
  \item{cluster_columns}{how to cluster columns. "subgroup" means only to cluster samples in every subgroup.}
