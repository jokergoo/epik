...
\arguments{
  ...
  \item{cr}{correlated regions generated by \code{\link{filter_correlated_regions}} or \code{\link{reduce_cr}}}
  \item{cutoff}{cutoff for p-values of ANOVA test}
  \item{suffix}{suffix of column names}

}
\details{
If \code{factor} is set in \code{\link{correlated_regions}}, this function can assign subtype specificity to each subtype.
